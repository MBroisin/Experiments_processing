...
# BA.show_video_frame(video_file, cropX=CROPS['0']['x'], cropY=CROPS['0']['y'], frame_of_interest=10)
# matplotlib.pyplot.show()
...
def save_zone(z_i, activity):
    ...
    res_df.to_pickle(ROOT_PATH+'/processed_data/acts/acts/'+exp_timestamp.strftime('%y%m%dT%H%M%S%Z')+'_z{}_acts.pickle'.format(crop_ind))
